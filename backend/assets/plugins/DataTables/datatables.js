 ...
 *   https://datatables.net/download/#bs4-4.6.0/dt-1.11.3/af-2.3.7/b-2.0.1/date-1.1.1/r-2.2.9/sp-1.4.0
 *
 * Included libraries:
 *   Bootstrap 4 4.6.0, DataTables 1.11.3, AutoFill 2.3.7, Buttons 2.0.1, DateTime 1.1.1, Responsive 2.2.9, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4-4.6.0/dt-1.11.3/af-2.3.7/b-2.0.1/date-1.1.1/r-2.2.9/sp-1.4.0",
