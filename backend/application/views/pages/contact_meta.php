                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row g-3 align-items-center">
                            <label class="control-label col-auto">details</label>
                            <div class="col">
                                <input name="details" id="details" placeholder="" class="form-control" type="text">
                        ...
                        <div class="form-group row g-3 align-items-center">
                            <label class="control-label col-auto">type</label>
                            <div class="col">
                                <input name="type" id="type" placeholder="" class="form-control"
                                    type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('control/ajax_contact_list/')?>",
            "data": {
                tbl: 'site_contact'
            },
            "type": "POST"
...
function save() {
    ...
    if (save_method == 'add') {
        ...
        url = "<?php echo site_url('control/ajax_site_contact_update')?>";
    }
