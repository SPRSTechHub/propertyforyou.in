              ...
              <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                  ...
                                  <th width="200px">fb</th>
                                  <th width="200px">twitter</th>
                                  <th width="200px">insta</th>
                                  <th width="200px">youtube</th>
                                  <th>Status</th>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row g-3 align-items-center">
                            <label class="control-label col-auto">FB</label>
                            <div class="col">
                                <input name="fb" id="fb" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>

                        <div class="form-group row g-3 align-items-center">
                            <label class="control-label col-auto">Insta</label>
                            <div class="col">
                                <input name="insta" id="insta" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>

                        <div class="form-group row g-3 align-items-center">
                            <label class="control-label col-auto">Twitter</label>
                            <div class="col">
                                <input name="twitter" id="twitter" placeholder="" class="form-control"
                                    type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row g-3 align-items-center">
                            <label class="control-label col-auto">Youtube</label>
                            <div class="col">
                                <input name="youtube" id="youtube" placeholder="" class="form-control"
                                    type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
...
function save() {
    ...
    if (save_method == 'add') {
        ...
        url = "<?php echo site_url('control/ajax_social_update')?>";
    }
...
function block_person(id) {
    if (confirm('Are you sure block this user?')) {
        // ajax delete data to database
        $.ajax({
            url: "<?php echo site_url('control/ajax_block')?>/" + id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
                //if success reload ajax table
