                  ...
                  <form action="#" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                          ...
                          <div class="form-group row g-3 align-items-center">
                              ...
                              <div class="col">
                                  <input name="privacy" id="privacy" placeholder="" class="form-control" type="text">
...
function save() {
    ...
    if (save_method == 'add') {
        url = "<?php echo site_url('control/store_privacy')?>";
    } else {
...
function delete_person(id) {
    if (confirm('Are you sure delete this data?')) {
        ...
        $.ajax({
            url: "<?php echo site_url('control/ajax_privacy_delete')?>/" + id ,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
